...
export const listeMots: Word[] = [
    ...
    { mot: "Pome", definition: "provient du pomier ;)", vertical: true, longeur: 4, premierX: 0, premierY: 0, activer: false },
    { mot: "Eppa", definition: "Pas super super", vertical: false, longeur: 4, premierX: 0, premierY: 3, activer: false },
    { mot: "Tata", definition: "Ni papa, ni  mama", vertical: true, longeur: 4, premierX: 3, premierY: 0, activer: false }
];
