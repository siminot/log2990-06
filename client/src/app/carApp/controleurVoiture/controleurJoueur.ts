...
export class ControleurJoueur implements IObjetEnMouvement {

    protected pointDestination: Point;

    public constructor(protected voiture: Voiture,
                       protected piste: Point[]) {
    ...
    protected miseAJourPoint(): void {
        if (this.pointDestinationAtteint) {
            this.passerProchainPoint();
        }
    }

    protected ajustementDirection(): void {
    ...
    protected ajustementVitesse(): void {
    ...
    protected get pointSuivant(): Point {
